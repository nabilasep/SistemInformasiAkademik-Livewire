<div>
    {{-- Header Halaman dengan Gradient --}}
    <x-slot name="header">
        <div class="bg-gradient-to-r from-blue-600 to-purple-600 -mx-4 -my-4 sm:-mx-6 sm:-my-6 lg:-mx-8 lg:-my-8 px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-blue-100 mt-1">Isi KRS untuk mahasiswa: {{ $mahasiswa->nama }}</p>
                </div>
            </div>
        </div>
    </x-slot>
                ...
                <div class="p-6 lg:p-8 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <form wire:submit.prevent="saveKrs">
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            @empty
                                <p class="text-gray-500 md:col-span-2">Tidak ada mata kuliah yang tersedia untuk prodi ini.</p>
                            @endforelse
                        </div>
